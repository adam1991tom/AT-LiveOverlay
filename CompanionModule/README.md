...
Development module for Bitfocus Companion. It connects to the AT LiveOverlay v4.0.3 HTTP API on TCP port 8765.
...
1. Install AT LiveOverlay v4.0.3 and open **Remote control** from its tray menu.
