...
[void]$sb.AppendLine('  <Package Name="AT LiveOverlay" Manufacturer="AT" Version="4.0.2" UpgradeCode="F4D7C037-96CC-4EF5-B75A-5438F62FD8F7" Scope="perMachine" InstallerVersion="500">')
